        ...
        <ul class="sidebar-menu">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li><a class="" href="<?=base_url('new_bookings.php')?>"><i class="fa fa-pencil"></i> New Bookings</a>
                    </li>
                    <li> <a class="" href="<?=base_url('confirmed_bookings.php')?>"><i class="fa fa-check"></i> Confirmed Bookings</a></li>
        </ul>
        </li>
