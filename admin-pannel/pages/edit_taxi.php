        ...
        <div class="panel-body">
            <div class="form">
                <form class="form-validate form-horizontal " id="register_form" method="post" action=""
                    ...
                    <div class="form-group ">
                        <label for="address">Seat Capacity <span class="required">*</span></label>
                    ...
                    <div class="form-group ">
                        <label for="username">Driver <span class="required">*</span></label>
                    ...
                    <div class="form-group ">
                        <label for="username">Taxi Color <span class="required">*</span></label>
